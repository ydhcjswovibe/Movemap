...
The important geometry contracts are: no horizontal overflow at 390px, action bar inside the viewport, timeline ending above the action bar, and stage frame width at or above 378px.
